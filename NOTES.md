...
**⚠️ LIVE DEFECT ON PROD — the preset-only role→permissions push RELABELS but does not APPLY (found 20 July 2026 by the 167 priority probe; shipped as-is, option C, Shiraz's call).**
