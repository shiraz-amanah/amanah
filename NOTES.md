...
**SECURITY FOLLOW-UP (logged 20 July 2026 during D3 — deliberately NOT fixed in the D3 commit; own session, migration 167) — `get_staff_sensitive` hands the owner plaintext `ni_number`, so D3's masked NI display is a UI control, not a transport barrier.**
