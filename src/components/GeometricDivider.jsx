  ...
  <div className={`w-full select-none ${className}`} aria-hidden="true">
    <svg viewBox="0 0 1152 72" preserveAspectRatio="xMidYMid slice" className="w-full h-10 md:h-14" role="presentation" focusable="false">
      <defs>
        ...
        <pattern id="amanah-zellij" width="72" height="72" patternUnits="userSpaceOnUse">
        ...
        <linearGradient id="amanah-zellij-fade" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0" stopColor="#fff" stopOpacity="0" />
          <stop offset="0.5" stopColor="#fff" stopOpacity="1" />
          <stop offset="1" stopColor="#fff" stopOpacity="0" />
        </linearGradient>
        <mask id="amanah-zellij-mask"><rect width="1152" height="72" fill="url(#amanah-zellij-fade)" /></mask>
      </defs>
      <rect width="1152" height="72" fill="url(#amanah-zellij)" mask="url(#amanah-zellij-mask)" />
    </svg>
  </div>
);
