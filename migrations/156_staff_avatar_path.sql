...
-- ====================================================================
-- >>> NOT YET APPLIED — SURFACED FOR APPROVAL (Commit A, staff-editing-v1). <<<
-- Do not apply until Shiraz approves. Dev-first, raw probes, STOP; prod only on
-- explicit go-ahead, and BEFORE the Commit A client code merges.
--
...
--
-- NUMBERING: this takes 156; the tentative bank-details audit-log table (Commit C)
-- shifts to 157.
-- ====================================================================
